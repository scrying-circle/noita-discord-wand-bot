...
async function getSpellList(dir) {
    ...
    const spell_list = await readFile(dir, { encoding: 'utf-8' }).then(data => {
...
const custom_spells = {
    "PROJ": new Spell("PROJECTILE", "data/ui_gfx/gun_actions/any_spell.png", "ACTION_TYPE_PROJECTILE"),
    "MOD": new Spell("MODIFIER", "data/ui_gfx/gun_actions/any_spell.png", "ACTION_TYPE_MODIFIER"),
    "DRAW": new Spell("DRAW_MANY", "data/ui_gfx/gun_actions/any_spell.png", "ACTION_TYPE_DRAW_MANY"),
    "MAT": new Spell("MATERIAL", "data/ui_gfx/gun_actions/any_spell.png", "ACTION_TYPE_MATERIAL"),
    "STATIC": new Spell("STATIC_PROJECTILE", "data/ui_gfx/gun_actions/any_spell.png", "ACTION_TYPE_STATIC_PROJECTILE"),
    "OTHER": new Spell("OTHER", "data/ui_gfx/gun_actions/any_spell.png", "ACTION_TYPE_OTHER"),
    "PASSIVE": new Spell("PASSIVE", "data/ui_gfx/gun_actions/any_spell.png", "ACTION_TYPE_PASSIVE"),
    "UTIL": new Spell("UTILITY", "data/ui_gfx/gun_actions/any_spell.png", "ACTION_TYPE_UTILITY"),
    "EMPTY": new Spell("EMPTY", "data/ui_gfx/empty.png", "NONE"),
    "ANY": new Spell("ANY", "data/ui_gfx/gun_actions/any_spell.png", "ANY"),
}
const get_spell_list = getSpellList("data/gun_actions.lua");
...
export const spellList = {...(await get_spell_list), ...custom_spells}